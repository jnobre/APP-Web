      ...
      <!-- Example row of columns -->
    	<div id="p1">
    		...
    		<a name="1"></a>
					...
					<a name="3"></a>
				  <hr>
					<h4 align="center">3. Como imprimo todas as ofertas?</h4><br>
					<div style="padding-left:5em;padding-right:5em;">
						<h5> Para imprimir todas as oferta clique em Listar de seguida clique onde está sinalizado na seguinte imagem, depois será exportado para um excel como poderá editar como pretende</h5>
                <img src="faq/perg3.jpg">
					</div>
