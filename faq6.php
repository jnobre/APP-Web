    ...
    <div class="container">
      ...
      <!-- Example row of columns -->
    	<div id="p1">
    			...
    			<hr>
					<h4 align="center">6. Quero comparar duas ofertas</h4><br>
					<div style="padding-left:5em;padding-right:5em;">
					<h5> Clique em Listar . </h5>
					<br> <img src="faq/p2.1.jpg">
					<br><br><br>
					<h5> Selecione duas ofertas que deseja comparar clicando na linha correspondente á oferta na tabela.</h5>

					<br> <img src="faq/p6.2.jpg"><br><br><br>
					<h5> Clique em Comparar Ofertas </h5>
					<h5> Irá ser mostrado uma tela de comparação que compara atributo a atributo</h5>
					<br>
					<img src="faq/p6.3.jpg">
					<br><br><br>
					<h5><font color="blue">Informação:</font> Não é permitido comparar mais que duas ofertas</h5>
					</div>
