      ...
      <!-- Example row of columns -->
    	<div id="p1">
    		...
    		<a name="1"></a>
				...
				<hr>
					<h4 align="center">4. Quero imprimir uma oferta detalhada</h4><br>
					<div style="padding-left:5em;padding-right:5em;">
						
						<h5> 1. Clique no menu listar </h5>
						<br>
						<img src="faq/p2.1.jpg">
						<br><br><br>
						<h5> Escolha a oferta a detalhar clicando no seu nome (Neste Exemplo iremos detalhar a oferta Edp casa).</h5>
						<img src="faq/p4.2.jpg">
						<br><br><br>
						<h5> Clique no botão de impressão ( Um pdf irá ser gerado)</h5>
						<br><img src="faq/p4.3.jpg">
						<br><br><br>
						<img src="faq/p4.4.jpg">
						<br><br><br>
						<h5> Abra o pdf e imprima com a configuração que deseja</h5>
						<br>
						<img src="faq/p4.5.jpg">
						<br><br><br>
						<h5><font color="blue">Informação:</font>Se no ecrã detalhar oferta esconder uma tabela , essa tabela será imprimida na mesma (Futuras versões poderão adicionar esta funcionalidade).</h5>
