    ...
    <div class="container">
      ...
      <!-- Example row of columns -->
    	...
    	<div style="padding-left:5em;padding-right:5em;">
						...
						<a name="5"></a>
				<hr>
					<h4 align="center">5. Como vejo o preçário de uma oferta(Gás ou Eletricidade) ?</h4><br>
						<h5>Escolha a oferta a detalhar, de seguida, se quiser detalhar eletricidade , procure a tabela 3.Eletricidade e clique em [Detalhar Tarifário] , se desejar detalhar um tarifário de gás , procure a tabela 4.Gás.</h5>
          <div align="center" style="padding-left:5em;padding-right:5em;">
          
              <br> <img src="faq/p5.1.jpg">
          <br><br><br>
