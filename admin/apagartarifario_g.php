<?php
    ...
    function apagartarifario($idgas,$mysqli)
    {
      //Sequencia de querys para apagar tarifario
      $mysqli->autocommit(FALSE);

      $mysqli->query("DELETE FROM ESCALAO WHERE EMPRESAS_DISTRIBUIDORAS_GAS_IDGAS=" . $idgas);
      $mysqli->query("DELETE FROM EMPRESAS_DISTRIBUIDORAS WHERE GAS_IDGAS=" . $idgas);
            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="gerirtarifario.php">Gerir Tarifário Eletricidade</a></li>
                  <li class="active"><a href="gerirtarifario_g.php">Gerir Tarifário Gás</a></li>
                  <li class="divider"></li>
  ...
  <div name="confirmeapagar" id="confirmeapagar" class="container marketing">  
    <fieldset align="center" >
        <table width='0%' height='0%' align="center" border="0" bordercolor="#000000" style="background-color:#FFFFFF" >
          ...
          <label>
          <?php
                $sucesso=apagartarifario($idgas,$mysqli);
          if($sucesso==TRUE)
          {
            ?>
