    ...
    <div class="container">
      ...
      <!-- Example row of columns -->
    	<div id="p1">
    		...
    		<a name="1"></a>
    		<h4 align="center">3. Gestão de Tarifários</h4><br>
        <hr>
    		<div style="padding-left:5em;padding-right:5em;">
    		   <h5> Clique em Gerir , e clique em Gestão de Tarifários de Eletricidade ou Gás dependendo do que pretende</h5>
    		   <h5> Pode actualizar,eliminar, e detalhar um tarifário</h5>    		   
          <h5> Actualizar um tarifário significa introduzir um novo preçário na base de dados.</h5>           
          <h5> Se a data em vigor inserida for maior que todas os outros preçários inseridos , ( e menor que a data actual) então todas as ofertas que estejam relacionadas com este tarifário irão mostrar o novo preçário inserido.</h5>           
    <br>
    <hr>
      <?php
