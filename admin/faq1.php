    ...
    <div class="container">
      ...
      <!-- Example row of columns -->
    	<div id="p1">
    		...
    		<a name="1"></a>
    		<h4 align="center">1. Gestão de Conta</h4><br>
    		<div style="padding-left:5em;padding-right:5em;">
    		<h4>1.1- Alterar Password</h4>
    		   <h5> Para alterar a password clique em gerir e depois em Minha Conta. </h5>
    		   <h5>Será apresentado dois campos para introduzir a password.</h5>
           <hr>
    		   <h4>1.2 Criar Conta</h4>
     		  <h5> Para criar uma conta clique em gerir e depois em criar user</h5>
          <h5> Introduza o username desejado e o email </h5>
          <h5> Será apresentado de seguida o login do utilizador , esse login deve ser fornecido posteriormente ao utilizador em questão </h5>
          <h5> Quando o utilizador efetuar o primeiro login, terá obrigatóriamente de mudar a sua password</h5>
          <hr>
          <h4>1.3- Gerir Utilizadores</h4>
          <h5>Para gerir todos os utilizadores (Excepto o administrador principal que não pode ser alterado excepto pelo próprio) clique em gerir e depois Gerir Users Existentes</h5>
          <h5>Irá ser apresentada uma tabela com todos os utilizadores registados no sistema , poderá editar e apagar.</h5>
          <h5>Se apagar ou editar um utilizador , este processo é ireversível</h5>
          <hr>
