  ...
  <body>
    ...
    {  
            ...
            {            
                        ...
                        {                   
                           ...
                           /* if(stripos($param_name,'select_tarifa_simples') !== false)
                            ...
                            if(stripos($param_name,'desconto_valor_') !== false)
                                $tarifas_simples[$contador]['desconto_valor']=$param_val;
                          ...
                          /*  if(stripos($param_name,'select_tarifa_bi') !== false)
                            ...
                            if(stripos($param_name,'desconto_bi_') !== false)
                                $tarifas_bi[$contador]['desconto_bi']=$param_val; 
                           ...
                           /* if(stripos($param_name,'select_tarifa_tri') !== false)
                            ...
                            if(stripos($param_name,'desconto_tri_') !== false)
                                $tarifas_tri[$contador]['desconto_tri']=$param_val;
                ...
                foreach($tarifas_simples as $k => $v) {
                   ...
                   /* if(!empty($v))
                    ...
                    {                         
                        $insert_stmt->bind_param('ddddddd',$ultimo_id_simples,$potencia,$v['preco_potencia_simples_tvcf'],$v['preco_energia_simples_tvcf'],$v['preco_potencia_simples_edpC'],$v['preco_energia_simples_edpC'],$v['desconto_valor']);
                ...
                {                  
                   /* echo($i." Campo bi == ".$k."<br>");
                    ...
                    {  
                        $insert_stmt->bind_param('ddddddddd',$ultimo_id_bi,$potencia,$v['energia_normal_bi_tvcf'],$v['energia_economico_bi_tvcf'],$v['preco_potencia_bi_tvcf'],$v['desconto_bi'],$v['energia_normal_bi_edpC'],$v['energia_economico_bi_edpC'],$v['preco_potencia_bi_edpC']);
                        $ok=$insert_stmt->execute();
                        $insert_stmt->close();      
                        $id_tarifa_bi=$mysqli->insert_id;
                        if(!$ok)
                    ...
                    else
                    {
                        ...
                        echo("<p align=center> Erro na Inserc&ccedil;&atilde;o TARIFA BI. Redirecionando...</p>");
                        $mysqli->close();
                        ?>
                ...
                foreach($tarifas_tri as $k => $v) 
                {
                    ...
                    {  
                        $insert_stmt->bind_param('ddddddddddd',$ultimo_id_tri,$potencia,$v['preco_potencia_tri_tvcf'],$v['energia_normal_tri_tvcf'],$v['energia_economico_tri_tvcf'],$v['energia_economico_super_tri_tvcf'],$v['desconto_tri'],$v['preco_potencia_tri_edpC'],$v['energia_normal_tri_edpC'],$v['energia_economico_tri_edpC'],$v['energia_economico_super_tri_edpC']);
                        $ok=$insert_stmt->execute();
                        $id_tarifa_simples=$mysqli->insert_id;
                        if(!$ok)
                        {
                ...
                else if($flag_1==-1)
                {
                    ...
                    echo "<div align='center'><h4>Inserc&ccedil;&atilde;o Tarifa Simples [<font color='#4CC417'>OK</font>]</h4></div>";
                ...
                else if($flag_2==-1)
                {
                    ...
                    $ultimo_id_bi=null;
                     ...
                     echo "<div align='center'><h4>Inserc&ccedil;&atilde;o Tarifa BI [<font color='#4CC417'>OK</font>]</h4></div>";
                ...
                else if($flag_3==-1)
                {
                    ...
                    echo "<div align='center'><h4>Inserc&ccedil;&atilde;o Tarifa TRI [<font color='#4CC417'>OK</font>]</h4></div>";
                ...
                else
                {
                    ...
                    ?>
                        <meta HTTP-EQUIV="REFRESH" content="5; url=gerirtarifario.php">
                    <?php
        ...
        else
        {
                ...
                echo("<div align='center'><h4>  J&aacute; existe o plano [".$nome_electricidade."] com ID tarif&aacute;rio [".$id_tarifario."].<br> Redirecionando...</h4></div>");
                $mysqli->close();
                ?>
                   <meta HTTP-EQUIV="REFRESH" content="3; url=gerirtarifario.php">
                <?php
        }
    }
    ...
    <form method="post" action="actualizare.php" onsubmit="return valida_dados(this);" name="criaroferta"> 
    <!---------------------- TABELA PRINCIPAL ---------------------->
                    ...
                    <fieldset align="center" >
                         <table  id="table_tarifa_electricidade" width='93%' height='50%' align="center" border="0" bordercolor="#000000" style="background-color:#FFFFFF;TABLE-LAYOUT: fixed;" >
                            ...
                            <tr class="hero-unit">
                                ...
                                <td align="left">
                                    <input disabled id="nome_tarifario" class="span5" type="text" value="<?php echo(base64_decode($nome));?>" placeholder="Nome Tarif&aacute;rio" name="nome_tarifario">               
                                </td>
                            </tr>
                            <tr class="hero-unit">
                                <td width="20%" align="center">
                                ...
                                <td align="left">
                                    <input disabled id="id_tarifario" class="span5" type="text" placeholder="ID Tarif&aacute;rio" value="<?php echo($et);?>" name="id_tarifario">             
                                </td> 
                            </tr>
                            <tr class="hero-unit">
                                <td   width="20%" align="center">
