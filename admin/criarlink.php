...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_POST['link']) && isset($_POST['nome_link']))
    {  
        
        $sql="INSERT INTO LINK (LINK,NOME) VALUES('" . $_POST['link'] . "'," . "'" . $_POST['nome_link'] . "')";
        mysql_query($sql) or die (mysql_error());
           echo("<div align='center'><img align=center width = 100 heigth = 100  src=../assets/img/EDP_logo.jpg></div><br>");
           echo("<div align='center'><h4> Link Inserido.<br> Redirecionando...</h4></div>");
                ?>
    ...
    <form method="post" action="criarlink.php"  name="criarlink"> 
    <!---------------------- TABELA PRINCIPAL ---------------------->
    ...
    <table width='100%' height='100%' align="center" border="0" bordercolor="#000000" style="background-color:#FFFFFF" >
        <tr>
                <td colspan = "2">
                    <label>
                        <h3>Adicionar Link Rápido</h3><hr>
                    </label>
                </td>            
        </tr> 
        <tr>
                    ...
                    <fieldset align="center" >
                         <table  id="table_link" width='93%' height='50%' align="center" border="0" bordercolor="#000000" style="background-color:#FFFFFF;TABLE-LAYOUT: fixed;" >
                            ...
                            <tr class="hero-unit">
                                ...
                                <td align="left">
                                    <input id="nome_link" class="span5" type="text" placeholder="Nome Link" name="nome_link">               
                                </td>
                            </tr>
                            <tr class="hero-unit">
                                <td width="20%" align="center">
                                ...
                                <td align="left">
                                    <input id="link" class="span5" type="text" placeholder="Link" name="link">             
                                </td> 
                            </tr>
                         </table>
                    </fieldset>    
